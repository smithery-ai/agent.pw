...
export const AuthScheme = z
  .discriminatedUnion("type", [ApiKeyScheme, HttpScheme, OAuth2Scheme])
  .meta({ id: "AuthScheme" });
...
export function getOAuthScheme(
  schemes: AuthScheme[],
): Extract<AuthScheme, { type: "oauth2" }> | undefined {
