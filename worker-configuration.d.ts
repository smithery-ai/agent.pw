/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c112d84c3d844ed038245b83aa3ec9b7)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		routes: [{"pattern":"warden.run","custom_domain":true}];
		HYPERDRIVE: Hyperdrive;
		DISCOVERY_WORKFLOW: Workflow<Parameters<import("./src/worker").DiscoveryWorkflow['run']>[0]['payload']>;
	}
}
